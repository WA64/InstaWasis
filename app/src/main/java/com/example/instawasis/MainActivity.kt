...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //1.Setting post description
        //2. Button to launch camera
        //3. ImageView to show image
        //4. Button to save/send post to Parse

        findViewById<Button>(R.id.bSubmit).setOnClickListener{
        ...
        findViewById<Button>(R.id.bTakePicture).setOnClickListener{
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                val ivPreview: ImageView = findViewById(R.id.iImagePost)
            ...
            override fun done(posts: MutableList<Post>?, e: ParseException?) {
                if (e != null){
                  //Something went wrong
                    ...
                    if (posts != null) {
                        for (post in posts){
                            Log.i(TAG,"Post " + post.getDescrpition() + " , username: " +
